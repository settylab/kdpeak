...
def sample_events_dict():
    ...
    events['chr1'] = pd.DataFrame({
        'variable': ['start'] * len(chr1_locations),
        'location': chr1_locations
    })
    ...
    events['chr2'] = pd.DataFrame({
        'variable': ['start'] * len(chr2_locations),
        'location': chr2_locations
    })
    ...
    events['chrX'] = pd.DataFrame({
        'variable': ['start'] * len(chrX_locations),
        'location': chrX_locations
    })
